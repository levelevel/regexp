//test_t data[] = {
    ...
    {__LINE__, "a$c",       "a\\$",             {"a$"},             1, 0, REG_EXTENDED},
    {__LINE__, "a$c",       "c\\$",             {""},               1, 1},
    {__LINE__, "a$c",       "c\\$",             {""},               1, 1, REG_EXTENDED},
    {__LINE__, "a$c",       "a$c",              {"a$c"},            1, 0},  //BREでは^,$は最初、最後だけ特殊な意味を持つ
    {__LINE__, "$bc",       "$b",               {"$b"},             1, 0},  //EREでは~,$は常に特殊な意味を持つ
    {__LINE__, "a$c",       "a$c",              {""},               1, 1, REG_EXTENDED},
    {__LINE__, "$bc",       "$b",               {""},               1, 1, REG_EXTENDED},
    {__LINE__, "\\abc",     "\\a",              {"a"},              1, 0},
    {__LINE__, "^abc",      "^a",               {""},               1, 1},
    {__LINE__, "a^bc",      "\\^b",             {"^b"},             1, 0},
    {__LINE__, "a^bc",      "a^b",              {"a^b"},            1, 0},
    ...
    {__LINE__, "abcabc",    "a\\(bc\\)a\\1",    {"abcabc","bc"},    2, 0},
    {__LINE__, "abcabc",    "\\(a\\(bc\\)\\)\\1",   {"abcabc","abc","bc"},  3, 0},
    {__LINE__, "abcabc",    "\\(a\\)\\(b\\)c\\1\\2",{"abcab","a","b"},      3, 0},
    {__LINE__, "abcabc",    "\\(...\\)\\1",     {"abcabc","abc"},   2, 0},
    {__LINE__, "<span>abc</span>",
                    "<\\(span\\)>.*</\\1>",     {"<span>abc</span>","span"},2, 0},
    {__LINE__, "aaabbbbc",  "\\([a-z]\\)\\1\\{3\\}",    {"bbbb","b"},   2, 0},
