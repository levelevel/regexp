#define TEST_DATA(a,b,c) {__LINE__,a,b,c},
    ...
    TEST_DATA("abc", "a\\{1,\\}", 1)
    TEST_DATA("abc", "a\\{2,\\}", 0)
    TEST_DATA("aabc", "a\\{2,\\}", 1)
    TEST_DATA("baaac", "a\\{2,\\}", 1)
    TEST_DATA("abc", "\\{1\\}", -1)
    ...
    TEST_DATA("abc", "a\\{0\\}", 1)
    TEST_DATA("abc", "a\\{0,0\\}", 1)
    TEST_DATA("abc", "a\\{,1\\}", 1)

    TEST_DATA("abc", "[a-z]\\{3\\}", 1)
    TEST_DATA("abc", "[a-z]\\{4\\}", 0)
    TEST_DATA("abc", "[a-z]\\{3,4\\}", 1)
    TEST_DATA("abc", "[a-z]\\{4,5\\}", 0)
    TEST_DATA("abc", ".\\{3\\}", 1)
    TEST_DATA("abc", ".\\{4\\}", 0)
